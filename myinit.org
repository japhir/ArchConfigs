...
** COMMENT make long lines faster
:LOGBOOK:
- Note taken on [2025-06-17 Tue 11:01] \\
  rnkr on #emacs told me these are not needed for left-to-right text and I probably don't have lines over 10k chars long
:END:
...
** COMMENT pulse
:LOGBOOK:
- Note taken on [2025-06-17 Tue 11:03] \\
...
** COMMENT using AUCTeX from AUR
#+begin_src emacs-lisp
  ;; recommended way to activate AUCTeX and preview-latex
