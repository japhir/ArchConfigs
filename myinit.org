...
<2023-06-05 Mon> I'm trying to clean up this biiiiiig file and simplify as needed. I'm using
https://github.com/SystemCrafters/crafted-emacs as a base for a new config!

For now, I'm going to start editing [[file:~/.emacs.d/early-init.el]] and [[file:~/.emacs.d/init.el]] directly, without the org-mode wrapper around it!

I will keep this file around until I've taken all the useful things out of it.

* COMMENT early-init
I tangle this manually hoping that it'll work.
...
* load systemcrafters completion config
:PROPERTIES:
...
-> disable ivy, ivy-bibtex, org-ref-ivy
#+begin_src emacs-lisp
