...
#+begin_src emacs-lisp
  ...
  (setq org-sec-me "Ilja")
  (global-set-key "\C-ch" 'org-sec-tag-entry)
#+end_src
**** overwrite some functions that have TASK hardcoded to WAIT
source code available on [[https://github.com/emacsmirror/org/blob/master/contrib/lisp/org-secretary.el][GitHub]]
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  (defun org-sec-who-view (par)
    ...
    (let ((who (read-string "Build todo for user/tag: "
                            "" "" "")))
      (org-sec-with-view "NEXT dowith" who)
      (org-sec-assigned-with-view "WAIT with" who)
...
#+begin_src emacs-lisp
  ...
  (setq org-agenda-custom-commands
        '(("i" "Inbox" tags "in")
          ...
          ("W" "Work" tags-todo
           "-Personal-doat={.+}-dowith={.+}/!-WAIT"
           ((org-agenda-todo-ignore-scheduled t)))
          ("P" "Personal" tags-todo
           "-Work-doat={.+}-dowith={.+}/!-WAIT"
           ((org-agenda-todo-ignore-scheduled t)))
          ("j" "NEXT dowith and WAIT with"
           ((org-sec-with-view "NEXT dowith")
            (org-sec-where-view "NEXT doat")
            (org-sec-assigned-with-view "WAIT with")
            (org-sec-stuck-with-view "STUCK with")))
          ("J" "Interactive NEXT dowith and WAIT with"
           ((org-sec-who-view "NEXT dowith")))
          ("R" "R" tags-todo "R")
          ("O" "org" tags-todo "org")
          ("B" "Bayes" tags-todo "bayes")
          ("g" . "GTD contexts")
          ("gj" "Projects" tags "prj/-SOME-DONE-CANC")
...
#+end_src
**** SOME add extra org-secretary filters
:LOGBOOK:
- State "SOME"       from              [2019-08-08 Thu 22:38]
:END:
http://juanreyero.com/article/emacs/org-teams.html
*** stuck projects
#+begin_src emacs-lisp
  (setq org-tags-exclude-from-inheritance '("prj")
        org-stuck-projects '("+prj/-CANC-DONE"
                             ("NEXT" "WAIT" "TICK") ()))  ;;  "SOME"
#+end_src
*** capture templates
