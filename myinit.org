  ...
  (use-package deft
    ...
    (setq deft-default-extension "org"
          ...
          '((noslash . "-")
            ...
            (case-fn . downcase)))
    :config
    (setq deft-directory "~/SurfDrive/bibliography/notes/")
...
#+begin_src emacs-lisp
  (use-package org-ref
    ...
    (setq org-ref-completion-library 'org-ref-ivy-cite
          ...
          ;; I think this one never gets used
...
#+begin_src emacs-lisp
  (use-package org-roam
    ...
    (org-roam-capture-ref-templates
     '(("r" "ref" plain
        "%?"
        ;; currently no longer contains the ROAM_REFS: property!
...
seems like this is what both [[jethro][jethro]] and [[https://github.com/zaeph/.emacs.d/blob/8243cd8c74775387e011de679f041ca8e3cff41a/init.el#L3865][zaeph]] seem to be using since org-roam v2 update
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  (defun japhir/insert-r-pipe ()
    ...
    (interactive)
    (just-one-space 1)
    (insert "%>%") ;; when R 4.1 hits I can replace this with |>
