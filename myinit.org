...
#+begin_src emacs-lisp
  (defface org-todo-next
    '((((class color) (min-colors 16) (background light)) (:family "Noto Sans Mono" :foreground "light goldenrod yellow" :bold t :background "red" :box (:line-width 2 :style released-button)))
      (((class color) (min-colors 16) (background dark))  (:family "Noto Sans Mono" :foreground "light goldenrod yellow" :bold t :background "red" :box (:line-width 2 :style released-button)))
      (((class color) (min-colors 8)  (background light)) (:family "Noto Sans Mono" :foreground "light goldenrod yellow" :bold t :background "red" :box (:line-width 2 :style released-button)))
      (((class color) (min-colors 8)  (background dark))  (:family "Noto Sans Mono" :foreground "light goldenrod yellow" :bold t :background "red" :box (:line-width 2 :style released-button)))
...
#+begin_src emacs-lisp
  (defface org-todo-waiting
    '((((class color) (min-colors 16) (background light)) (:family "Noto Sans Mono" :foreground "dim gray" :bold t :background "yellow" :box (:line-width 2 :style released-button)))
      (((class color) (min-colors 16) (background dark))  (:family "Noto Sans Mono" :foreground "dim gray" :bold t :background "yellow" :box (:line-width 2 :style released-button)))
      (((class color) (min-colors 8)  (background light)) (:family "Noto Sans Mono" :foreground "dim gray" :bold t :background "yellow" :box (:line-width 2 :style released-button)))
      (((class color) (min-colors 8)  (background dark))  (:family "Noto Sans Mono" :foreground "dim gray" :bold t :background "yellow" :box (:line-width 2 :style released-button)))
      (t (:inverse-video t :bold t)))
...
#+begin_src emacs-lisp
  (defface org-todo-tick
    '((((class color) (min-colors 16) (background light)) (:family "Noto Sans Mono" :bold t :background "light slate blue" :box (:line-width 2 :style released-button)))
      (((class color) (min-colors 16) (background dark))  (:family "Noto Sans Mono" :bold t :background "light slate blue" :box (:line-width 2 :style released-button)))
      (((class color) (min-colors 8)  (background light)) (:family "Noto Sans Mono" :bold t :background "light slate blue" :box (:line-width 2 :style released-button)))
      (((class color) (min-colors 8)  (background dark))  (:family "Noto Sans Mono" :bold t :background "light slate blue" :box (:line-width 2 :style released-button)))
      (t (:inverse-video t :bold t)))
...
#+begin_src emacs-lisp
  (defface org-todo-someday
    '((((class color) (min-colors 16) (background light)) (:family "Noto Sans Mono" :foreground "ghost white" :bold t :background "deep sky blue" :box (:line-width 2 :style released-button)))
      (((class color) (min-colors 16) (background dark))  (:family "Noto Sans Mono" :foreground "ghost white" :bold t :background "deep sky blue" :box (:line-width 2 :style released-button)))
      (((class color) (min-colors 8)  (background light)) (:family "Noto Sans Mono" :foreground "ghost white" :bold t :background "deep sky blue" :box (:line-width 2 :style released-button)))
      (((class color) (min-colors 8)  (background dark))  (:family "Noto Sans Mono" :foreground "ghost white" :bold t :background "deep sky blue" :box (:line-width 2 :style released-button)))
      (t (:inverse-video t :bold t)))
...
#+begin_src emacs-lisp
  (defface org-done-done
    '((((class color) (min-colors 16) (background light)) (:family "Noto Sans Mono" :foreground "green4" :bold t :background "pale green" :box (:line-width 2 :style released-button)))
      (((class color) (min-colors 16) (background dark)) (:family "Noto Sans Mono" :foreground "green4" :bold t :background "pale green" :box (:line-width 2 :style released-button)))
      (((class color) (min-colors 8)) (:family "Noto Sans Mono" :foreground "green" :background "pale green" :box (:line-width 2 :style released-button)))
      (t (:bold t)))
...
#+begin_src emacs-lisp
  (defface org-done-cancelled
    '((((class color) (min-colors 16) (background light)) (:family "Iosevka" :foreground "dim gray" :bold t :background "gray" :box (:line-width 2 :style released-button)))
      (((class color) (min-colors 16) (background dark)) (:family "Iosevka" :foreground "dim gray" :bold t :background "gray" :box (:line-width 2 :style released-button)))
      (((class color) (min-colors 8)) (:family "Iosevka" :foreground "dim gray" :background "gray" :box (:line-width 2 :style released-button)))
      (t (:bold t)))
...
#+begin_src emacs-lisp
  ...
  (add-to-list 'org-latex-packages-alist
               '("" "siunitx" nil))
  ;; (setcdr org-latex-packages-alist nil)
#+end_src
...
#+begin_src emacs-lisp
  (use-package stan-mode
    ...
    (setq org-babel-stan-cmdstan-directory "/home/japhir/.cmdstanr/cmdstan-2.28.0"))
#+end_src
...
#+RESULTS:
| prettify-symbols-mode | turn-on-auto-fill | turn-on-reftex | rainbow-delimiters-mode |
