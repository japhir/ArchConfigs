...
#+begin_src emacs-lisp
  ...
  (org-preview-latex-default-program 'imagemagick)
...
#+begin_src emacs-lisp
  (use-package emojify
    ...
    :hook (mu4e mu4e-view mu4e-compse org))
#+end_src
** yasnippet
