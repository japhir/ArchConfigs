...
;; If there is more than one, they won't work right.
 ...
 '(package-selected-packages
   (quote
    (bug-hunter systemd emacs-systemd-mode systemd-mode stan-mode mu4e-conversation org-pdfview counsel-projectile projectile org-mu4e use-package telephone-line ranger rainbow-mode rainbow-delimiters polymode ox-tufte org-ref org-plus-contrib org-noter org-gcal org-bullets openwith mu4e-alert monokai-theme leuven-theme ivy-bibtex hl-todo gmail-message-mode fontawesome flycheck evil-org evil-nerd-commenter evil-mu4e evil-magit evil-leader evil-escape evil-collection ess edit-server diminish define-word counsel beacon auto-complete ace-window))))
(custom-set-faces
